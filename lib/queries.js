...
// Version-compatible query for table columns
// codec_expression was added in ClickHouse 20.1+
...
// Extended version with codec_expression for ClickHouse 20.1+
export const GET_TABLE_COLUMNS_WITH_CODEC = `
  SELECT
    name,
    type,
    default_kind,
...
// system.dependencies table was added in ClickHouse 20.3+
// This is the preferred query for newer versions
...
// Fallback query for older ClickHouse versions without system.dependencies
// This extracts dependencies from materialized view definitions
export const GET_DEPENDENCIES_FROM_VIEWS = `
SELECT
  database,
...
WHERE engine = 'MaterializedView'
  AND (database = '{database}' OR dependencies_database = '{database}')
